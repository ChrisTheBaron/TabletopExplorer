async function InitIconSelect(db) {
    ...
    IconSelect.COMPONENT_ICON_FILE_PATH = '/static/lib/iconselect.js-1.0/images/control/icon-select/arrow.png';
    ...
    icons.push({ 'iconFilePath': '/static/lib/fontawesome-free-5.15.1-web/svgs/solid/ban.svg', 'iconValue': '' });
