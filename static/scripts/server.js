...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    async function startSharing() {
        ...
        if (window.localStorage.getItem(lsSharingTopic) != null &&
            window.localStorage.getItem(lsSharingTopic) != null) {
            topic = window.localStorage.getItem(lsSharingTopic);
            write = window.localStorage.getItem(lsSharingWrite);
        } else {
            ...
            topic = result.topic;
            write = result.write;
            window.localStorage.setItem(lsSharingTopic, result.topic);
            window.localStorage.setItem(lsSharingWrite, result.write);
        }
        ...
        $('#sharingLink').val(location.protocol + '//' + location.host + '/viewer/?t=' + share.topic + '&k=' + share.key);
    ...
    $('#regenerateKey').click(async (e) => {
        ...
        window.localStorage.removeItem(lsSharingWrite);
